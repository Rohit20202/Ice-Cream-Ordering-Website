   ...
   $select_profile = $conn->prepare("SELECT * FROM `sellers` WHERE id = ? LIMIT 1");
...
?>
   ...
   <body>
      ...
      <div class="box-container">
         ...
         <div class="box">
      <?php
         $select_deactive_products = $conn->prepare(
            "SELECT * FROM `products` WHERE seller_id = ? AND status = ?"
         );
   ...
   <div class="box">
     ...
     <?php
               ...
               $number_of_canceled_orders = $select_confirm_orders->rowCount();
            ?>
