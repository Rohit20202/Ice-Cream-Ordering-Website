...
<div class="banner">
    <div class="detail">
        <h1>order detail</h1>
        <p>Review all the information about your order, including items <br> purchased, keep track of your order and manage your purchases with ease.</p>
        <span>
...
<div class="order-detail">
    <div class="heading">
        ...
        <p>Get a detailed summary of your order and manage your order efficiently with ease.</p>
...
<?php if ($fetch_order['status'] == 'canceled') { ?>
    <p class="disabled">Cancelled Order</p>
    <a href="checkout.php?get_id=<?= $fetch_product['id']; ?>" class="btn" style="line-height: 3;">Order Again</a>
<?php } else { ?>
    <form action="" method="post">
        <button type="submit" name="cancel" class="btn" onclick="return confirm('Don you want to cancel this order?');">Cancel</button>
    </form>
<?php } ?>
       </div>
      </div>
