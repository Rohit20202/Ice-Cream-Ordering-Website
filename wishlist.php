...
if (isset($_POST['delete_item'])) {
   ...
   if ($verify_delete_item->rowCount() > 0) {
      ...
      $success_msg[] = 'Item removed form wishlistvsuccessfully';
    } else {
...
<head>
   ...
   <title>Ice Cream Delights - my wishlist page</title>
...
<div class="banner">
   <div class="detail">
      <h1>my wishlist</h1>
      <p>Browse and manage all the items you've added to your wishlist. Keep <br> track of your favorite products and make it easier to purchase them later.</p>
      <span>
